...
`pnpm bootstrap` walks you through everything. It checks your toolchain, provisions D1 and R2 in your Cloudflare account, generates a session secret (you never see it), prompts for your OpenRouter key, applies migrations, and deploys. About 90 seconds end to end. Re-runnable — safe to invoke if something goes wrong partway through.
